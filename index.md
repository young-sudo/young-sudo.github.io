...
<div class="cards-container">
  ...
  <a class="card-link content content-1" href="{{ '/bio/' | relative_url }}">
         <img src="{{ '/assets/img/bio.svg' | relative_url }}" alt="BI Logo" class="card-logo">
         <h2>
            Bioinformatics
         </h2>
         <!-- <p>
  ...
  <a class="card-link content content-2" href="{{ '/ml/' | relative_url }}">
      <img src="{{ '/assets/img/ml.svg' | relative_url }}" alt="ML Logo" class="card-logo">
      <h2>
        Machine Learning
      </h2>
      <!-- <p>
  ...
  <a class="card-link content content-3" href="{{ '/sys/' | relative_url }}">
      <img src="{{ '/assets/img/sys.svg' | relative_url }}" alt="CS Logo" class="card-logo">
      <h2>
        Systems & Ops
      </h2>
      <!-- <p>
